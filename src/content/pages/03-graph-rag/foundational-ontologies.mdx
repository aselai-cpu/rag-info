...
The <CrossReference slug="03-graph-rag/rag-ontology-map" /> maps RAG concepts to DOLCE categories. But DOLCE is not the only foundational ontology. **BFO** and **SUMO** offer different categorization schemes — and the choice affects how you model, reason about, and extend the RAG ontology.
...
1. <CrossReference slug="03-graph-rag/ontology" /> introduced endurants and perdurants
2. <CrossReference slug="03-graph-rag/competency-questions" /> showed how to ask the right questions
3. <CrossReference slug="03-graph-rag/rag-ontology-map" /> derived the complete RAG ontology from those questions
