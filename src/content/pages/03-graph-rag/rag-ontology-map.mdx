...
The <CrossReference slug="03-graph-rag/competency-questions" /> showed us how to ask the right questions. Now we answer them — producing a formal ontology of RAG concepts grounded in DOLCE foundational categories.
...
This ontology is grounded in DOLCE. But other foundational ontologies (BFO, SUMO) would categorize these same entities differently. See <CrossReference slug="03-graph-rag/foundational-ontologies" /> for a comparison.
